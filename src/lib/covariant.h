...
class covariant_t {
	public:
		// C++17 Parameter pack expansion and std::in_place would make this a little nicer
		template <class Ctor, class ...Args>
		explicit covariant_t(Ctor* /*tag*/, Args&&... args) : dtor{&detail::destructor_wrapper<Base, Ctor>} {
